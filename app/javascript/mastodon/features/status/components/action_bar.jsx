...
import SimpleDropdownMenuContainer from '../../../containers/simple_dropdown_menu_container';
    ...
    return (
      <div className='detailed-status__action-bar'>
        ...
        <div className='detailed-status__action-bar-dropdown'>
          <SimpleDropdownMenuContainer icon='ellipsis-h' iconComponent={MoreHorizIcon} status={status} items={menu} direction='left' title={intl.formatMessage(messages.more)} />
        </div>
      </div>
    );
  }
